  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-md" data-testid="cat-photo-upload-dialog">
        <DialogHeader>
          <DialogTitle className="text-2xl font-serif text-center">Upload a photo of your cat!</DialogTitle>
        </DialogHeader>
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            >
              <div className="flex items-center gap-2 px-6 py-3 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition-colors">
                ...
                <span>{preview ? "Choose Different Photo" : "Choose Photo"}</span>
              </div>
              <input
                id="cat-photo-input"
                type="file"
            ...
            <p className="text-sm text-muted-foreground text-center">
              Upload a photo of your cat to personalize your tarot experience
            </p>
          </div>
